    ...
    return (
        <div id="services" className="w-full md:mt-10 md:mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div data-aos="zoom-in-right"  data-aos-duration="3000" className="text-center shadow-2xl p-7 rounded-md mx-8 md:mx-0 border-2 border-[#1d3557]">
                ...
                <div data-aos="zoom-in-up" data-aos-duration="1500" className="text-center shadow-2xl p-7 rounded-md mx-8 md:mx-0 border-2 border-[#1d3557]">
                    <BiCodeAlt className="mx-auto text-5xl p-2 shadow-2xl bg-[#1d3557] rounded-full text-white" />
                ...
                <div data-aos="zoom-in-left" data-aos-duration="3000" className="text-center shadow-2xl p-7 rounded-md mx-8 md:mx-0 border-2 border-[#1d3557]">
