import my_photo from "../../assets/284948270_1180922872743342_7054802084820640476_n.jpg";
    ...
    return (
        <div id="home" className="relative md:flex md:justify-between md:items-center md:w-10/12 mx-auto">
            <div className="fixed z-40 -mt-24 md:-mt-0 md:-ml-20">
                <div className="flex md:flex-col items-center justify-between my-6 md:my-0 mx-10 md:mx-0 px-7 md:px-3 py-3 md:py-0 space-x-9 md:space-x-0 md:space-y-8 rounded-lg bg-gradient-to-t from-[#dbd364] to-[#838BD6]">
            ...
            <div className="md:w-1/2 pb-10 px-10 md:px-0 md:pb-10 md:pr-10 mt-24 md:mt-0">
                ...
                <TypeAnimation
                    className="text-3xl md:text-4xl font-bold font-mono text-[#838BD6]"
                    sequence={[
                        "Sohel Raza",
                        1000,
                ...
                <div className="md:flex items-center md:space-x-3 mt-5">
                    <a href="/public/Web Developer Resume of Sohel Raza.pdf" className="btn-outlined flex items-center">Resume<BsDownload className="ml-2" /></a>
            ...
            <div className="md:w-1/3 md:mt-10 py-10 px-10 md:px-0">
                <img className="w-full h-full border-8 border-[#838BD6] rounded-full" src={my_photo} alt="" />
