...
const Banner = () => {
    return (
        <div id="home" className="relative md:flex md:justify-between md:items-center w-full">
            <div className="fixed z-40 -mt-24 md:-mt-0 md:-ml-20">
                <div className="flex text-[#e7f3f0] md:flex-col items-center justify-between my-6 md:my-0 mx-10 md:mx-0 px-7 md:px-3 py-3 md:py-0 space-x-8 md:space-x-0 md:space-y-8 rounded-lg bg-gradient-to-t from-[#01754F] to-[#3fe3ad]">
            ...
            <div className="md:w-1/2 pb-10 px-10 md:px-0 md:pb-10 md:pr-10 mt-24 md:mt-0">
                ...
                <TypeAnimation
                    className="text-3xl md:text-4xl font-bold font-mono text-[#01754F]"
                    sequence={[
                        "Sohel Raza",
                        1000,
            ...
            <div className="md:w-1/3 md:mt-10 py-10 px-10 md:px-0">
                <img className="w-full h-full rounded-full border-4 border-[#63616f]" src={my_photo} alt="" />
                <div className="flex justify-center items-center space-x-4 mt-5">
                    <a href="https://github.com/Sohel0Raza"><BsGithub className="shadow-2xl rounded-full text-4xl border-2 border-[#88A6A3] p-1" /></a>
                    <a href="https://www.linkedin.com/in/sohel-raza-361640282/"><BsLinkedin className="shadow-2xl rounded-full text-4xl border-2 border-[#88A6A3]  p-1" /></a>
                    <a href="https://www.facebook.com/Mou.Himu12/"><BsFacebook className="shadow-2xl rounded-full text-4xl border-2 border-[#88A6A3]  p-1" /></a>
                </div>
            </div>
        </div>
    );
