...
const MyService = () => {
    ...
    return (
        <div id="services" className="md:w-10/12 mx-auto md:mt-10 md:mb-20">
            
            <h2 className="font-mono font-bold text-4xl my-10 pb-2 px-10 md:px-0">My Services</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div data-aos="zoom-in-right"  data-aos-duration="3000" className="text-center shadow-2xl p-7 rounded-md mx-8 md:mx-0 border-2 border-[#dbd364]">
                    <MdDesignServices className="mx-auto text-5xl p-2 shadow-2xl bg-[#dbd364] rounded-full text-white" />
                ...
                <div data-aos="zoom-in-up" data-aos-duration="1500" className="text-center shadow-2xl p-7 rounded-md mx-8 md:mx-0 border-2 border-[#dbd364]">
                    <BiCodeAlt className="mx-auto text-5xl p-2 shadow-2xl bg-[#dbd364] rounded-full text-white" />
                ...
                <div data-aos="zoom-in-left" data-aos-duration="3000" className="text-center shadow-2xl p-7 rounded-md mx-8 md:mx-0 border-2 border-[#dbd364]">
                    <BsPhoneFill className="mx-auto text-5xl p-2 shadow-2xl bg-[#dbd364] rounded-full text-white" />
